...
interface ProductCardProps {
  ...
  imageUrl: string;
  href: string;
  children?: React.ReactNode;  // Allowing children to be passed into the card
}

export function ProductCard({ name, price, imageUrl, href, children }: ProductCardProps) {
  return (
    <Link href={href} className="group block">
      <div className="relative aspect-square md:aspect-[3/4] w-full overflow-hidden bg-[#F9F9F9] mb-3 md:mb-6">
        <Image
      ...
      {/* Render children (e.g., the Add to Cart button) here */}
